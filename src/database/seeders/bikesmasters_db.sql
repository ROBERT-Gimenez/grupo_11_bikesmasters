...
--
-- Host: localhost    Database: bikesmaster
-- ------------------------------------------------------
...
CREATE TABLE `carrito` (
  ...
  CONSTRAINT `carrito_FK_1` FOREIGN KEY (`product_id`) REFERENCES `productos` (`id`),
...
CREATE TABLE `usuarios` (
  ...
  CONSTRAINT `usuarios_FK_2` FOREIGN KEY (`product_id`) REFERENCES `productos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'bikesmaster'
--
...
-- Dump completed on 2022-06-01 22:39:32
